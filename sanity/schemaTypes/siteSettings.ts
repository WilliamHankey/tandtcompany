...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({ name: "companyName", title: "Registered Company Name", type: "string", initialValue: "T AND T COMPANY (Pty) Ltd" }),
    defineField({ name: "companyRegNumber", title: "Company Reg Number (CIPC)", type: "string" }),
    defineField({ name: "physicalAddress", title: "Physical Address (full)", type: "text", rows: 3, description: "Street/building, suburb, city, province, postcode" }),
